...
function ProductList({ selectedProductsList, setSelectedProductsList }) {
            ...
            <div className="ml-14 flex gap-2 items-center">
              ...
              {variantDiscountButtons[productIndex][variantIndex] ? (
                <div className="flex gap-3">
                  <input
                    type="number"
                    className="bg-white shadow-md rounded-md hover:border cursor-pointer overflow-hidden h-11 w-16 flex items-center p-4 justify-between focus-visible:outline focus-visible:outline-2 focus-visible:outline-green-700"
                  />
                  <select
                    id="Discount"
                    className="bg-white shadow-md rounded-md cursor-pointer overflow-hidden h-11 w-24 flex items-center pl-3 justify-between focus-visible:outline focus-visible:outline-2 focus-visible:outline-green-700"
                  >
                ...
                <button
                  ...
                  className="cursor-pointer w-32 rounded-md bg-green-700 px-3.5 py-2.5 text-m font-semibold text-white shadow-sm hover:bg-green-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
                >
                  Add Discount
                </button>
              )}
  ...
  return (
    <div className="px-4 mt-5 overflow-y-auto">
      {showProductPicker && (
        <ProductPicker
